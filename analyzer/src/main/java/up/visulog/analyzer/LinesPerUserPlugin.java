...
public class LinesPerUserPlugin extends Plugin{
	...
	static class Result implements AnalyzerPlugin.Result{
		...
		public Webgen.Graph[] getResultAsGraphArray() {
            ...
            return new Webgen.Graph[]{new Webgen.BarGraph("<i class=\"fas fa-stream\"></i>","Lines per User", labelsArray, new String[]{"Lines added", "Lines deleted"}, new double[][]{dataArray, dataArray2}, new Color[][]{c1, c2})};
        }
