...
///Cette classe permet de definire c'est quoi un commit. Elle possede la methode parseLogFromCommand qui prend
// le chemin vers le projet et initialise un ProcessBuilder qui permet d'executer des commandes dans le terminal.
// Pour instant elle éxécute juste la commande git log.
